...
export interface DeployStatusContent {
  type: "deploy_status";
  status: "ready" | "building" | "running" | "deployed" | "packaged" | "stopped" | "failed";
  url?: string;
}
...
export type ConversationPurpose = "normal" | "agent_builder";
...
export type ArtifactType = "code" | "diff" | "preview" | "file" | "deploy_status" | "document" | "link_preview" | "plan" | "orchestrator_summary" | "agent_config";
...
export interface DocumentArtifactContent {
  fileName: string;
  fileUrl: string;
  fileType: "pdf" | "docx" | "xlsx" | "ppt" | "pptx";
  fileSize: number;
  previewUrl?: string;
  originalUrl?: string;
...
export interface PlanSubtask {
  ...
  agentConfig?: AgentCreationConfig;
