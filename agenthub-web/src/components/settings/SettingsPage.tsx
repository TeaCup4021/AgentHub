  ...
  return (
    <div style={{ display: "flex", flex: 1, minHeight: 0, borderRadius: 8, overflow: "hidden", boxShadow: "var(--shadow-card)" }}>
      ...
      <nav style={{
        ...
        <div style={{ fontSize: 13, fontWeight: 600, color: "var(--color-text-tertiary)", padding: "0 16px 8px", letterSpacing: "0.5px" }}>
          设置
        </div>
        {NAV_ITEMS.map((item) => {
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "var(--color-bg-sidebar)" }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 16, fontWeight: 600, color: "var(--color-text-primary)" }}>外观</span>
          <div
            onClick={onClose}
            style={{
              width: 28, height: 28,
        ...
        >
          ...
          <section ref={(el) => registerSection("appearance", el)}>
            ...
            <Card style={{ border: "1px solid var(--color-card-border)", boxShadow: "var(--shadow-card)" }}>
              <ThemeRadioCards value={theme} onChange={setTheme} />
            </Card>

            <div style={{ marginTop: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 600, color: "var(--color-text-primary)", marginBottom: 2 }}>背景底色</div>
              <div style={{ fontSize: 12, color: "var(--color-text-tertiary)", marginBottom: 10 }}>调整画布底色，仅影响浅色主题</div>
            </div>
