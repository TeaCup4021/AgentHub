...
class MessageCreate(BaseSchema):
    ...
    mode: Optional[str] = None  # "direct" | "auto_orchestrate" | "refine_plan" | "confirm_plan" | "agent_builder"
    plan_id: Optional[UUID] = None  # confirm_plan / refine_plan mode
    plan: Optional[List[dict]] = None  # confirm_plan mode: stage plan items, no concrete agent required
