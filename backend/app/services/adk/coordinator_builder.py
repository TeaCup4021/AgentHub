...
class CoordinatorBuilder:
    ...
    def _build_coordinator_instruction(self, agents: list[AgentModel]) -> str:
        ...
        return (
            ...
            "4. If multiple specialists were used, combine their results concisely\n"
            "5. Only ask for clarification when a specialist's output is incomplete or unclear\n"
            "6. Do not add unnecessary commentary or summaries\n\n"
