...
from app.core.schema_compat import ensure_runtime_schema
...
from app.services.preview_server import asset_app, preview_app, serve_app
app.mount("/preview", preview_app)
app.mount("/serve", serve_app)
